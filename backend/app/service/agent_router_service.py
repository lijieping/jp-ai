...
agent_modes_registry = {
    "personal_assistant": {
        ...
        "example": """
用户：“明天上海天气怎么样？”
你：{"decision": "personal_assistant", "reason": "这是一个简单的天气信息查询，属于日常事务范畴。", "user_query_for_next": "明天上海天气怎么样？"}
        """
    },
    "company_affairs": {
        "name": "公司事务",
...
你：{"decision": "company_affairs", "reason": "这是一个涉及市场分析、产品设计的复杂商业项目，需要多部门专家协作。", "user_query_for_next": “我想做一款针对00后的社交APP，帮我分析下市场并出个初步方案。”}
        """
    }
}
...
"""
    ...
    for mode_id, mode_info in registry.items():
        prompt += f"""**启动【{mode_info["name"]}（id为{mode_id}）】模式，{mode_info["description"]},如果请求满足以下任一条件：**\n"""
...
def route_with_llm(user_input: str) -> str:
